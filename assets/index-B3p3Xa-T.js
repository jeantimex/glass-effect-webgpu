var N=Object.defineProperty;var j=(i,e,t)=>e in i?N(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var d=(i,e,t)=>j(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();const L={leaves:"/assets/leaves.jpg",banner:"/assets/banner.jpeg"};function $(){return{bezelWidth:60,glassThickness:50,scaleRatio:1,surfaceType:0,gridCellSize:105,gridSpeed:40,specularOpacity:.4,specularAngle:Math.PI/3,bgBrightness:1,specularSaturation:4,specularType:0,scaleX:1,scaleY:1,blurAmount:0,blurType:1,shadowOpacity:.1,shadowBlur:30,shadowOffsetX:0,shadowOffsetY:15,progressiveBlur:0,progressiveBlurType:0,glassBgOpacity:0,refractiveIndex:1.5,magnifyingScale:0,circleSize:1,shapeType:0,rectWidth:420,rectHeight:96,rectRadiusPercent:100,glassTintR:1,glassTintG:1,glassTintB:1,useImageBg:!1,switchMode:!1,sliderMode:!1,switchProgress:1,switchTrackWidth:160,switchTrackHeight:67,switchTrackOffOpacity:.34,switchTrackOnOpacity:.86,maxDisplacementScale:.8,splitMenuMode:!1,splitMenuProgress:0,liquidEnabled:!0,iconType:0,iconOpacity:.8,iconScale:.45,iconColorR:1,iconColorG:1,iconColorB:1}}function Q(i){const e=window.devicePixelRatio||1,t=i.clientWidth*e,s=i.clientHeight*e;(i.width!==t||i.height!==s)&&(i.width=t,i.height=s)}function R(i,e){return Math.min(i.width,i.height)*.35*e.circleSize}function E(i){const e=window.devicePixelRatio||1,t=i.rectWidth*e,s=i.rectHeight*e,r=Math.min(Math.max(i.rectRadiusPercent,0),100)/100,a=Math.min(t,s)*.5*r;return{width:t,height:s,radius:a}}function K(i,e){if(e.shapeType===1){const s=E(e);return{halfWidth:s.width/2,halfHeight:s.height/2}}const t=R(i,e);return{halfWidth:t,halfHeight:t}}function z(i,e,t,s){const r=window.devicePixelRatio||1,a=e.switchTrackWidth*r,n=e.switchTrackHeight*r,c=e.rectWidth*r,l=e.rectHeight*r,p=t*i.width,o=s*i.height,h=5*r,m=Math.max(0,a-Math.max(n,Math.min(c,l))-h*2);return{centerX:p,centerY:o,trackWidth:a,trackHeight:n,travel:m}}function C(i,e,t){const s=i.getBoundingClientRect(),r=i.width/s.width,a=i.height/s.height;return{x:(e-s.left)*r,y:(t-s.top)*a}}function G(i,e,t,s,r){const a=Math.abs(i)-(t/2-r),n=Math.abs(e)-(s/2-r),c=Math.max(a,0),l=Math.max(n,0),p=Math.min(Math.max(a,n),0);return Math.sqrt(c*c+l*l)+p-r}function Z(i,e,t,s,r,a){const n=C(i,r,a),c=t*i.width,l=s*i.height,p=n.x-c,o=n.y-l;if(e.shapeType===1){const h=E(e);return G(p,o,h.width,h.height,h.radius)<=0}return Math.sqrt(p*p+o*o)<=R(i,e)}function J(i,e,t,s,r,a){const n=C(i,r,a),c=t*i.width,l=s*i.height,p=window.devicePixelRatio||1,o=(n.x-c)/e.scaleX,h=(n.y-l)/e.scaleY,m=R(i,e),y=m*2,w=e.splitMenuProgress,P=320*p*w,x=e.rectWidth*p,f=y+(x-y)*w,_=(m-f*.5)*.5,b=_-P*.5,T=_+P*.5;if(Math.sqrt((o-b)**2+h**2)<=m)return!0;const q=y*.5;return G(o-T,h,f,y,q)<=0}function ee(i,e,t,s,r,a){if(!e.switchMode&&!e.sliderMode)return!1;const n=C(i,r,a),c=z(i,e,t,s),l=c.trackHeight/2;return G(n.x-c.centerX,n.y-c.centerY,c.trackWidth,c.trackHeight,l)<=0}const te=`struct Uniforms {
  canvas_width: f32,
  canvas_height: f32,
  time: f32,
  glass_center_x: f32,
